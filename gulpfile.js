...
import { compileStyles, compileMinStyles, copyStyles } from './gulp/compileStyles.mjs';
...
const build = gulp.series(clean, copy, sprite, gulp.parallel(compileMinStyles, copyStyles, compileScripts, pug));
const dev = gulp.series(clean, copy, sprite, gulp.parallel(compileMinStyles, copyStyles, compileScripts, pug, optimizePng, optimizeJpg, optimizeSvg), syncServer);
